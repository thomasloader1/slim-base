...
<?php $__env->startSection('admin.styles'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(siteUrl('adm_assets/css/switch.css')); ?>">
                    ...
                    <div class="collapse dont-collapse-sm" id="displayOptions">
                        ...
                        <div class="float-md-right dropdown-as-select">
                            <button class="btn btn-outline-dark btn-xs" type="button" data-toggle="modal"
                                data-target="#modal-add-banner"><a href="<?php echo e(siteUrl('admin/products/add')); ?>"> Crear producto</a></button>
                        </div>
                    </div>
                </div>
            </div>
...
<?php $__env->startSection('admin.scripts'); ?>
    ...
    <script>
        function toogleEditModal(user_id) {
            ...
            $.ajax({
                url: "<?php echo e(siteUrl('/admin/forms/product/edit')); ?>",
                type: "GET",
                data: {
                    id: user_id
                },
        ...
        function productosactivar(banner) {
            ...
            if (!t) {
                $.ajax({
                    url: '<?php echo e(siteUrl("/admin/forms/banners/active")); ?>',
                    type: 'POST',
                    data: {
                        id_banner: banner,
                        status: 0
        ...
        function deleteProducts(id) {
            Swal.mixin({
                ...
                if (result.isConfirmed == true) {
                    $.ajax({
                        type: 'delete',
                        url: "<?php echo e(siteUrl('/admin/forms/products')); ?>/" + id,
                        success: function(data) {
        ...
        $(document).ready(function() {
            ...
            var table = $('#tabla-nueva').DataTable({
                ...
                "ajax": {
                    'url': "<?php echo e(siteUrl('/admin/tables/products')); ?>"
                },
                "columns": [{
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\slim-base\src\Views/admin/products/list-product.blade.php ENDPATH**/ ?>