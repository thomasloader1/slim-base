            ...
            <div class="mb-2"><a class="btn pt-0 pl-0 d-inline-block d-md-none" data-toggle="collapse"
                ...
                <div class="collapse dont-collapse-sm" id="displayOptions">
                    ...
                    <div class="float-md-right dropdown-as-select">
                        <button class="btn btn-outline-dark btn-xs" type="button" data-toggle="modal" data-target="#modal-add-banner"><a href="<?php echo e(siteUrl('admin/banners/order')); ?>"> Ordenar</a></button>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/nicolasmolina/Sites/ecommerce/src/Views/admin/banners.blade.php ENDPATH**/ ?>