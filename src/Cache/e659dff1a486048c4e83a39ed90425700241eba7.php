...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title"> <i class="fa fa-users"></i> Agentes</h4>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-12">
        <div class="card m-b-30">
            <div class="card-body">
                    <h4 class="mt-0 header-title">Listado de agentes</h4>
                                        ...
                                        <div id="modal-add-user" class="modal fade" role="dialog" aria-hidden="true">
                                            <div class="modal-dialog modal-lg">
                                                <div id="modal-add-user-content" class="modal-content">
                                                    <form id="addUser" action="<?php echo e(siteUrl('/forms/employee/add')); ?>" method="POST">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title mt-0">Agregar Agente</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                        </div>
                                                        <div class="modal-body" id="modal-add-user-body">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" type="text" value="" id="modal-add-user-name" name="modal-add-user-name" placeholder="Nombre" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label" for="modal-add-user-last-name" >Apellido</label>
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" type="text" value="" id="modal-add-user-last-name" name="modal-add-user-last-name" placeholder="Apellido" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label" for="modal-add-user-dni" >DNI</label>
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" type="number" value="" id="modal-add-user-dni" name="modal-add-user-dni" placeholder="DNI" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label" for="modal-add-user-legajo" >Legajo</label>
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" type="number" value="" id="modal-add-user-legajo" name="modal-add-user-legajo" placeholder="Número de legajo" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label" for="modal-add-user-role" >Contraseña</label>
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" type="text" value="" id="modal-add-user-pass" name="modal-add-user-pass" placeholder="Contraseña" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
...
<script src="<?php echo e(siteUrl('adm_assets/plugins/select2/js/i18n/es.js')); ?>" type="text/javascript"></script>
    ...
    <script>
        ...
        function toogleEditModal(user_id){
            ...
            $.ajax({
                url: "<?php echo e(siteUrl('/forms/employee/edit')); ?>",
                type: "GET",
                data: {id:user_id},
                cache: false,
                success: function (data) {
        ...
        $(document).ready(function() {
            ...
            var table = $('#datatable').DataTable({
                ...
                "ajax":{
                    'url': "<?php echo e(siteUrl('/tables/agentes')); ?>"
                }
            });
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/nicolasmolina/Sites/salliquelo-recibos/src/Views/admin/employees.blade.php ENDPATH**/ ?>