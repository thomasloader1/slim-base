        ...
        <div class="main-menu">
            <div class="scroll">
                <ul class="list-unstyled">
                    <li <?php if($menuSection == 'dashboard'): ?> class="active" <?php endif; ?>><a href="#dashboard"><i class="iconsminds-shop-4"></i>
                            <span>Dashboards</span></a></li>
                    <li <?php if($menuSection == 'website'): ?> class="active" <?php endif; ?>><a href="#website"><i class="iconsminds-digital-drawing"></i> Página web</a>
                    </li>
        ...
        <div class="sub-menu">
            <div class="scroll">
                ...
                <ul class="list-unstyled" data-link="products" id="products">
                    ...
                    <li <?php if($subMenuSection == 'products'): ?> class="active" <?php endif; ?>>
                    ...
                    <li>
                        ...
                        <div id="products-category-menu" class="collapse show" >
                            <ul class="list-unstyled inner-level-menu">
                                <li <?php if($subMenuSection == 'products.categories'): ?> class="active" <?php endif; ?>>
                                    <a href="<?php echo e(siteUrl('/admin/categories')); ?>">
                                        <i class="simple-icon-list"></i>
                            ...
                            <ul class="list-unstyled inner-level-menu" >
                                <li <?php if($subMenuSection == 'products.sub-categories'): ?> class="active" <?php endif; ?>>
                                    <a href="#">
                                        <i class="simple-icon-list"></i>
                    ...
                    <li>
                        ...
                        <div id="products-brands-menu" class="collapse show">
                            <ul class="list-unstyled inner-level-menu">
                                <li <?php if($subMenuSection == 'products.add-brand'): ?> class="active" <?php endif; ?>>
                                    <a href="<?php echo e(siteUrl('/admin/brands/add')); ?>">
                                        <i class="simple-icon-note"></i>
                            ...
                            <ul class="list-unstyled inner-level-menu">
                                <li <?php if($subMenuSection == 'products.brand'): ?> class="active" <?php endif; ?>>
                                    <a href="<?php echo e(siteUrl('/admin/brands')); ?>">
                                        <i class="simple-icon-list"></i>
...
<?php /**PATH C:\xampp\htdocs\slim-base\src\Views/layouts/admin.blade.php ENDPATH**/ ?>