...
<?php $__env->startSection('admin.styles'); ?>
    ...
    <link href="<?php echo e(siteUrl('adm_assets/js/vendor/dropzone/css/dropzone.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(siteUrl('adm_assets/css/vendor/select2.min.css')); ?>" rel="stylesheet" />
...
<?php $__env->startSection('admin.main'); ?>
    ...
    <div class="container-fluid">
            ...
            <div class="col-12">
                ...
                <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                    <ol class="breadcrumb pt-0">
                        <li class="breadcrumb-item"><a href="<?php echo e(siteUrl('/admin/products')); ?>">Listado de productos</a>
                        </li>
        ...
        <form id="saveProductForm" action="<?php echo e(siteUrl('/admin/forms/products/add')); ?>" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="idTemporal" id="" value="<?php echo e($idTemporal); ?>">
...
<?php $__env->startSection('admin.scripts'); ?>
    <script src="<?php echo e(siteUrl('adm_assets/js/vendor/select2.full.js')); ?>"></script>
    <script src="<?php echo e(siteUrl('adm_assets/js/vendor/datatables/datatables.min.js')); ?>"></script>
    <script src="<?php echo e(siteUrl('adm_assets/js/vendor/ckeditor5-build-classic/ckeditor.js')); ?>"></script>
    <script src="<?php echo e(siteUrl('adm_assets/js/vendor/dropzone/dropzone.min.js')); ?>"></script>
    ...
    <script>
        $(document).ready(function() {
            $("#category").select2({
                ...
                width: "100%",
                ajax: {
                    url: "<?php echo e(siteUrl('/admin/select/categories')); ?>",
                    dataType: 'json'
                }
            });
        ...
        $("#saveProductForm").submit(function(e) {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    setTimeout(() => {
                        $(window).attr('location',"<?php echo e(siteUrl('/admin/products')); ?>");
                    }, 1000);
                }
            });
        });
        ...
        const myDropzone = new Dropzone("#my-dropzone", {
            url: "<?php echo e(siteUrl('/admin/forms/products/images/add/' . $idTemporal)); ?>",
            addRemoveLinks: true,
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\slim-base\src\Views/admin/products/add-product.blade.php ENDPATH**/ ?>