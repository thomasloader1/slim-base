                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div id="modal-sync-content" class="modal-content">
                                                        ...
                                                        <div class="modal-body" id="modal-sync-body">
                                                            <p id="modal-sync-body-text">El proceso de sincronización puede demorar unos segundos.</p>
                                                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#btn-sync").click( function(){
                    $("#modal-sync-body").html('Se está realizando la sincronización, aguarde un momento.');
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        success: function (data) {
                            $("#modal-sync-body").html('El proceso de sincronización puede demorar unos segundos.');
                            $("#modal-sync").modal('toggle');
