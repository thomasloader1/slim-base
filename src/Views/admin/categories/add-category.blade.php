    ...
    <div class="container-fluid">
            ...
            <div class="col-12">
                ...
                <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                    <ol class="breadcrumb pt-0">
                        <li class="breadcrumb-item"><a href="{{ siteUrl('/admin/categories') }}">Listado de categorias</a></li>
        ...
        <div class="row">
            <div class="card col-12 mb-4">
                <div class="card-body">
                    <form id="saveForm" action="{{ siteUrl('/admin/categories/add') }}" method="POST"
                        ...
                        <div class="form-group row">
                            <label for="category-name" class="col-sm-2 col-form-label">Nombre de la categoría</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="category-name" name="category-name"
                                    placeholder="Nombre de la categoría" value="">
                            </div>
                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var table = $('#tabla-nueva').DataTable({
                ...
                "ajax": {
                    'url': "{{ siteUrl('/admin/tables/categories') }}"
                },
                "columns": [{
            ...
            $("#saveForm").submit(function(e) {
                ...
                $.ajax({
                    ...
                    processData: false,
                    success: function(data) {
                        fireSuccess('Banner creado con éxito');
                        setTimeout(() => {
