                    ...
                    <div class="collapse dont-collapse-sm" id="displayOptions">
                        ...
                        <div class="float-md-right dropdown-as-select">
                            <button class="btn btn-outline-dark btn-xs" type="button" data-toggle="modal"
                                data-target="#modal-add-banner"><a href="{{ siteUrl('admin/banners/sort') }}">
                                    Ordenar</a></button>
                            <button class="btn btn-outline-dark btn-xs" type="button" data-toggle="modal"
                                data-target="#modal-add-banner"><a href="{{ siteUrl('admin/banners/add') }}"> Crear banner</a></button>
                        </div>
                    </div>
                </div>
            </div>
...
@section('admin.scripts')
    ...
    <script>
        function toogleEditModal(user_id) {
            ...
            $.ajax({
                url: "{{ siteUrl('/admin/forms/bannner/edit') }}",
                type: "GET",
                data: {
                    id: user_id
                },
        ...
        function deleteBanner(id) {
            Swal.mixin({
                ...
                if (result.isConfirmed == true) {
                    $.ajax({
                        type: 'delete',
                        url: "{{ siteUrl('/admin/forms/banners') }}/" + id,
                        success: function(data) {
