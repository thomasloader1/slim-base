...
<div id="modal-add-user" class="modal fade" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div id="modal-add-user-content" class="modal-content">
            <form id="addUser" action="{{siteUrl('/admin/forms/users/add')}}" method="POST">
                ...
                <div class="modal-body" id="modal-add-user-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" value="" id="modal-add-user-username" name="modal-add-user-username" placeholder="Nombre que usará para ingresar" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label" for="modal-add-user-pass" >Contraseña</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label" for="modal-add-user-repeat-pass" >Repetir contraseña</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="password" value="" id="modal-add-user-repeat-pass" placeholder="Contraseña" required data-parsley-equalto="#modal-add-user-pass">
                        </div>
                    </div>
                    <div class="form-group row">
...
<script>
        ...
        $(document).ready(function() {
            ...
            var table = $('#tabla-nueva').DataTable({
                ...
                "ajax":{
                    'url': "{{siteUrl('/admin/tables/users')}}"
                }
            });
