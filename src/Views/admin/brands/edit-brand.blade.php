    ...
    <div class="container-fluid">
            ...
            <div class="col-12">
                ...
                <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                    <ol class="breadcrumb pt-0">
                        <li class="breadcrumb-item"><a href="{{ siteUrl('/admin/brands') }}">Listado de marcas</a>
                        </li>
        ...
        <div class="row">
            <div class="card col-12 mb-4">
                <div class="card-body">
                    <form id="saveForm" action="{{ siteUrl('/admin/brands/edit/') . $brand->id }}" method="POST"
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label" for="brand-file">
                                Imagen
                            </label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="name" name="name"
                                    placeholder="Nombre del producto" value="{{ $brand->name }}">
                            </div>
                        </div>
    ...
    <script>
        ...
        function deleteUser(id) {
            Swal.mixin({
                ...
                $.ajax({
                    type: 'delete',
                    url: "{{ siteUrl('/admin/forms/brands') }}/" + id,
                    success: function(data) {
        ...
        $(document).ready(function() {
            ...
            $("#saveForm").submit(function(e) {
                ...
                $.ajax({
                    ...
                    processData: false,
                    success: function(data) {
                        fireSuccess('Marca modificada con éxito');
                        setTimeout(() => {
