...
<head>
	...
	<style type="text/css" media="screen">
		body { padding:0 !important; margin:0 auto !important; display:block !important; min-width:100% !important; width:100% !important; background:#f5faec; -webkit-text-size-adjust:none }
		a { color:#1A672C; text-decoration:none }
		...
		.l-pink a { color: #cddc39; }
		.l-grey a { color: #6e6e6e; }
		.l-purple a { color: #9128df; }

		.gradient { background: linear-gradient(to right, #1A672C 0%,#a3fdb8 100%); }

		.btn-secondary { border-radius: 10px; background: linear-gradient(to right, #9028df 0%,#cb2328 100%); }
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td class="mpx-10">
											...
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td class="text-12 c-grey l-grey a-right py-20" style="font-size:12px; line-height:16px; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; color:#6e6e6e; text-align:right; padding-top: 20px; padding-bottom: 20px;">
															<a href="#" target="_blank" class="link c-grey" style="text-decoration:none; color:#6e6e6e;"><span class="link c-grey" style="text-decoration:none; color:#6e6e6e;">Ver este correo online</span></a>
														</td>
													</tr>
												</table>											<!-- END Top --> --}}
											...
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
												<tr>
													<td class="gradient pt-10" style="border-radius: 10px 10px 0 0; padding-top: 10px;" bgcolor="#cb2328">
														<table width="100%" border="0" cellspacing="0" cellpadding="0">
															<tr>
																<td style="border-radius: 10px 10px 0 0;" bgcolor="#afb42b">
																	<!-- Logo -->
																	<table width="100%" border="0" cellspacing="0" cellpadding="0">
																		<tr>
																			<td class="img-center p-30 px-15" style="font-size:0pt; line-height:0pt; text-align:center; padding: 30px; padding-left: 15px; padding-right: 15px;">
																				<a href="http://www.salliquelo.gob.ar/control" target="_blank"><img src="http://www.salliquelo.gob.ar/recibos/img/logo_chico.png"  border="0" alt="" style="max-width: 400px"/></a>
																			</td>
																		</tr>
																	</table>
																	<!-- Logo -->
																					...
																					<tr>
																						<td class="pb-50" style="padding-bottom: 50px;">
																							<table width="100%" border="0" cellspacing="0" cellpadding="0">
																								...
																								<tr>
																									<td class="text-16 lh-26 a-center" style="font-size:16px; color:#242424; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 26px; text-align:left;">
																										Te damos la bienvenida al Sistema de Recibos del Municipio de Salliqueló<br>

                                                                                                        
Te dejamos tus datos para que los tengas siempre a mano:<br><br>
Usuario: {{$new_user->email}}<br>
Contraseña: <b>{{$new_pass}}</b><br><br>

La contraseña es generada en forma automática al crear tu usuario. Después de ingresar por primera vez, puedes editarla desde tu perfil.<br>

A partir de este momento, ya puedes comenzar a editar tu espacio virtual.<br><br>


Municipalidad de Salliqueló.<br>
																									</td>
																								</tr>
																							</table>
																						</td>
																						...
																						<td class="pb-50" style="padding-bottom: 50px;">
																							<table width="100%" border="0" cellspacing="0" cellpadding="0">
																								...
																								<tr>
																									<td align="center">
																										<!-- Button -->
																										<table border="0" cellspacing="0" cellpadding="0" style="min-width: 200px; border-spacing: 10px;">
																											<tr>
																												<td class="btn-16 c-white l-white" bgcolor="#223b00" style="font-size:16px; line-height:20px; mso-padding-alt:15px 35px; font-family:'PT Sans', Arial, sans-serif; text-align:center; font-weight:bold; text-transform:uppercase; border-radius:25px; min-width:auto !important; color:#ffffff;">
																													<a href="http://www.salliquelo.gob.ar/control" target="_blank" class="link c-white" style="display: block; padding: 15px 35px; text-decoration:none; color:#ffffff;">
																														<span class="link c-white" style="text-decoration:none; color:#ffffff;">Acceder</span>
																													</a>
																												</td>
											...
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td class="text-12 lh-22 a-center c-grey- l-grey py-20" style="font-size:12px; color:#6e6e6e; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 22px; text-align:center; padding-top: 20px; padding-bottom: 20px;">
															© 2020 Municipalidad de Salliqueló | by <a href="https://anteojosnegros.com" target="_blank" style="color: #111;font-weight: 600;">AnteojosNegros</a>
														</td>
													</tr>
												</table>											<!-- END Bottom -->
										</td>
